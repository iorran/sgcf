...
use App\Models\CardioAptidao;
use App\Models\CardioExame;
use App\Models\CardioFator;
use App\Models\CardioSintoma;
use DB;
...
class CardioController extends Controller {
	 ...
	 */
	public function updateCardio(Request $request, $id) {
		try {
			DB::beginTransaction ();
