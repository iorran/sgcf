									...
									<div class="form-group @if($errors->has('nome')) {!! 'has-error' !!} @endif">
										...
										<div class="col-md-4">
											<input id="nome" name="nome" type="text"
												...
												value="{{ old('nome',  isset($paciente->nome) ? $paciente->nome : null) }}" disabled>
									...
									<div class="form-group @if($errors->has('profissao')) {!! 'has-error' !!} @endif">
										...
										<div class="col-md-4">
											<input id="profissao" name="profissao" type="text"
												...
												value="{{ old('profissao',  isset($paciente->profissao) ? $paciente->profissao : null) }}" disabled>
									...
									<div class="form-group @if($errors->has('telefone')) {!! 'has-error' !!} @endif">
										...
										<div class="col-md-4">
											<input id="telefone" name="telefone" type="number"
												...
												value="{{ old('telefone',  isset($paciente->telefone) ? $paciente->telefone : null) }}" disabled>
									...
									<div class="form-group @if($errors->has('nascimento')) {!! 'has-error' !!} @endif">  
										...
										<div class="col-md-4">
											<input id="nascimento" name="nascimento" type="date"
												...
												value="{{ old('nascimento',  isset($paciente->nascimento) ? $paciente->nascimento : null) }}" disabled>
									...
									<div class="form-group @if($errors->has('nacionalidade')) {!! 'has-error' !!} @endif">
										...
										<div class="col-md-4">
											<input id="nacionalidade" name="nacionalidade" type="text"
												...
												value="{{ old('nacionalidade',  isset($paciente->nacionalidade) ? $paciente->nacionalidade : null) }}" disabled>
									...
									<div class="form-group @if($errors->has('naturalidade')) {!! 'has-error' !!} @endif"> 
										...
										<div class="col-md-4">
											<input id="naturalidade" name="naturalidade" type="text"
												...
												value="{{ old('naturalidade',  isset($paciente->naturalidade) ? $paciente->naturalidade : null) }}" disabled>
									...
									<div class="form-group @if($errors->has('numero')) {!! 'has-error' !!} @endif">
										...
										<div class="col-md-4">
											<input id="numero" name="numero" type="number" placeholder="Nº"
												...
												value="{{ old('numero',  isset($paciente->endereco->numero) ? $paciente->endereco->numero : null) }}" disabled>
									...
									<div class="form-group @if($errors->has('cep')) {!! 'has-error' !!} @endif">
										...
										<div class="col-md-4">
											<input id="cep" name="cep" type="number" placeholder="CEP"
												class="form-control input-md"
												value="{{ old('cep',  isset($paciente->endereco->cep) ? $paciente->endereco->cep : null) }}" disabled>
									...
									<div class="form-group @if($errors->has('bairro')) {!! 'has-error' !!} @endif">
										...
										<div class="col-md-4">
											<input id="bairro" name="bairro" type="text" placeholder="Bairro"
												class="form-control input-md"
												value="{{ old('bairro',  isset($paciente->endereco->bairro) ? $paciente->endereco->bairro : null) }}" disabled>
									...
									<div class="form-group @if($errors->has('cidade')) {!! 'has-error' !!} @endif">
										...
										<div class="col-md-4">
											<input id="cidade" name="cidade" type="text" placeholder="Cidade"
												class="form-control input-md"
												value="{{ old('cidade',  isset($paciente->endereco->cidade) ? $paciente->endereco->cidade : null) }}" disabled>
									...
									<div class="form-group @if($errors->has('estado')) {!! 'has-error' !!} @endif">
										...
										<div class="col-md-4">
											<input id="estado" name="estado" type="text" placeholder="Estado"
												class="form-control input-md"
												value="{{ old('estado',  isset($paciente->endereco->estado) ? $paciente->endereco->estado : null) }}" disabled>
